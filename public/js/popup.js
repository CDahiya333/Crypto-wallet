...
const settings={
  apiKey: process.env.POLYGON_AMOY,
...
let address;
 ...
 function getSelectedNetwork(e) {
  ...
  if (e.target.innerHTML === "Ethereum Mainnet") {
    ...
    providerURL =
      "https://eth-holesky.g.alchemy.com/v2/-2C_9gpIqlhGwXCCU3W6iQU7_i-FRbov";
    document.getElementById("network").style.display = "none";
  } else if (e.target.innerHTML === "Sepolia test network") {
    providerURL = "https://eth-sepolia.g.alchemy.com/v2/-2C_9gpIqlhGwXCCU3W6iQU7_i-FRbov";
    document.getElementById("network").style.display = "none";
  }
